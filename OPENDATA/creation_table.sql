...
dateCreationEtablissement DATETIME COMMENT "de création de l’établissement",
...
typeVoieEtablissement VARCHAR(151) COMMENT "Type de voie",
...
codeCommuneEtablissement VARCHAR(5) COMMENT "commune de l’établissement",
codeCedexEtablissement VARCHAR(9) COMMENT "Code cedex",
libelleCedexEtablissement VARCHAR(100) COMMENT "Libellé du code",
...
complementAdresse2Etablissement VARCHAR(38) COMMENT "Commplément d’adresse secondaire",
...
libelleCommuneEtranger2Etablissement VARCHAR(100) COMMENT "Libellé de la commune de l’adresse secondaire pour un
